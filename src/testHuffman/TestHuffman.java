...
class TestHuffman {
	...
	private final File[] VALID_FILE = new File[] {
			new File ("src/testHuffman/ValidFile1.txt"),
			new File ("src/testHuffman/ValidFile2.txt"),
			new File ("src/testHuffman/ValidFile3.txt"),
			new File ("src/testHuffman/ValidFile4.txt")
	};
	
	// creation of Huffman tree to test
	private final Huffman TREETOTEST1 = new Huffman("src/testHuffman/ATester1.txt");
	private final Huffman TREETOTEST2 = new Huffman("src/testHuffman/ATester2.txt");
	private final Huffman TREETOTEST3 = new Huffman("src/testHuffman/ATester3.txt");
	private final Huffman TREETOTEST4 = new Huffman("src/testHuffman/ATester4.txt");
	
	// creation of valid Huffman tree 
	private final Huffman VALID_TREE1 = new Huffman("src/testHuffman/ValidFile1.txt");
	private final Huffman VALID_TREE2 = new Huffman("src/testHuffman/ValidFile2.txt");
	private final Huffman VALID_TREE3 = new Huffman("src/testHuffman/ValidFile3.txt");
	private final Huffman VALID_TREE4 = new Huffman("src/testHuffman/ValidFile4.txt");
	...
	void testSameMapContent() {
		...
		Huffman treeToTest = new Huffman("src/testHuffman/ATester1.txt");
