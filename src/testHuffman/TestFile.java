...
class TestFile {
	private final File TEST_WRITE_AND_READ = new File("Z:\\BUT-INFO-1\\SAE\\SAE 2.02\\Huffman\\src\\testHuffman\\ATesterWriteRead.txt");
	...
	@Test
	void testGetPath() {
		assertEquals("Z:\\BUT-INFO-1\\SAE\\SAE 2.02\\Huffman\\src\\testHuffman\\ATester1.txt", VALID_FILE[0].getPath());
		assertEquals("Z:\\BUT-INFO-1\\SAE\\SAE 2.02\\Huffman\\src\\testHuffman\\ATester2.txt", VALID_FILE[1].getPath());
		assertEquals("Z:\\BUT-INFO-1\\SAE\\SAE 2.02\\Huffman\\src\\testHuffman\\ATester3.txt", VALID_FILE[2].getPath());
		assertEquals("Z:\\BUT-INFO-1\\SAE\\SAE 2.02\\Huffman\\src\\testHuffman\\ATester4.txt", VALID_FILE[3].getPath());
	}
    ...
    // TODO regler problème
    //test qui verfie qu'il est impossible d'ecrire avec un nom de fichier incorrect
    @Test
    void testWriteBinaryStringToFile_InvalidFileName() {
        File fileName = new File("*");
        String binaryString = "010";
        assertThrows(IllegalArgumentException.class, () -> fileName.binaryWrite(binaryString));
        
        File fileName2 = new File("//test");
        String binaryString2 = "01001";
        assertThrows(IllegalArgumentException.class, () -> fileName2.binaryWrite(binaryString2));
        
        File fileName3 = new File("test*");
        String binaryString3 = "010";
        assertThrows(IllegalArgumentException.class, () -> fileName3.binaryWrite(binaryString3));
        
        File fileName4 = new File("///test///*");
        String binaryString4 = "010";
        assertThrows(IllegalArgumentException.class, () -> fileName4.binaryWrite(binaryString4));
    }
