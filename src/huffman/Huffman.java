...
public class Huffman {
    ...
    public LinkedHashMap<Character, Double> countFrequency() {
        ...
        while (!frequencyMap.isEmpty()) {
            ...
            // TODO : un meilleur système de tri
            for (Character character : frequencyMap.keySet()) {
    ...
    /**
     * Écrit la structure de l'arbre de Huffman dans un fichier texte.
     * @param filePath le chemin du fichier où enregistrer l'arbre de Huffman
     */
    public void saveTree(String filePath) {
        try {
            FileWriter writer = new FileWriter(filePath);
            for (HashMap.Entry<Character, String> entry : tree.entrySet()) {
                String line = "codeHuffman = " + entry.getValue() + " ; encode = " + encodeSymbol(entry.getKey()) + " ; symbole = " + entry.getKey();
                writer.write(line + "\n");
            }
            writer.close();
    ...
    /**
     * Encodes a symbol to its binary representation.
     * @param symbol the symbol to encode
     * @return the binary representation of the symbol
     */
    private String encodeSymbol(Character symbol) {
...
//        String encodedLines = "";
        String encodedLines = null;
		try {
			encodedLines = file.binaryRead();
		} catch (IOException e) {
			System.err.println("Erreur lors du décodage");
		}
        String suite = "";
